...
Focus on producing accurate word scores. Use corpus data, agent research outputs, and your judgment to estimate probabilities. The trader will make their own trading decisions based on the scores and market data — do not include trade recommendations or portfolio construction advice.

CRITICAL: Return your entire response as a SINGLE JSON object.
